import { Mail, MapPin, Phone,Linkedin,Twitch,Twitter, Instagram, Send, } from "lucide-react"
            ...
            <div className="container mx-auto max-w-5xl">
                ...
                <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit,
                     repudiandae voluptate aliquid quisquam odit nisi?
                </p>
                        ...
                        <div className="space-y-6 justify-center">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:pavithramoorthi719@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">pavithramoorthi719@gmail.com</a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+91 8925184169" className="text-muted-foreground hover:text-primary transition-colors">+91 8925184169</a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a className="text-muted-foreground hover:text-primary transition-colors">Tirunelveli, Tamilnadu, India</a>
                                </div>
                            </div>
                        </div>
                        <div className="p-8 ">
